...
goodyImage.src = "img/goodies.png"; 
...
baddieImage.src = "img/baddies.png"; 
...
var main = function () {
    if (checkWin()) {
        ...
        //vérifier les collisions goodies
        for (var i in goodies) {
...
//verifier les collisions baddies
for (var i in baddies) {
